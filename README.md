...
All data in this repository was collected from publicly accessible APIs provided by federated instances on the Mastodon network.

The dataset contains only instance-level metadata (e.g., instance names, user counts, rules, and federation relationships). No user-level or personally identifiable information (PII) was collected, stored, or analyzed.

Data was collected in accordance with publicly available API endpoints. This repository is intended for research and informational purposes only and does not attempt to identify or profile individual users.

---

## AI Use Disclosure

This repository was developed by the author. No source code was generated by AI tools.

AI assistance (specifically Claude) was used only for non-code tasks such as:

organizing repository structure
improving documentation clarity
minor formatting and cleanup

All code, analysis, and core logic were written by the author.
