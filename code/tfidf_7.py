#ranking for log scale with plotly (Rank) 
...
# Reading translated rule dataset 
...
# Define bins for user count based on log scale
bins = [1, 10, 100, 1000, 10000, 100000, 1000000, 10000000]  
bin_labels = ['1 to 10', '11 to 100', '101 to 1000', '1001 to 10000', 
              '10001 to 100000', '100001 to 1000000', '100001 to 10000000']
...
tfidf_matrix = tfidf.fit_transform(merged_df['cleaned translated text'].dropna())
...
groups = merged_df.groupby('User Count Bin')
...
for group_name, group_data in groups:
    ...
    # Display words that have a score of 0
    zero_score_words = summed_scores[summed_scores == 0].index
    print(f"Words with 0 score in group {group_name}: {list(zero_score_words)}")
...
custom_order = ['1 to 10', '11 to 100', '101 to 1000', '1001 to 10000', 
              '10001 to 100000', '100001 to 1000000', '100001 to 10000000']
