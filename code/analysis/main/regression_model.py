# regression_model.py
#
# Runs five OLS regression models predicting lexical features (word count,
# rule count, TTR, FK readability) from instance-level predictors:
#   Model 1: log user count only
#   Model 2: log federating number only
#   Model 3: instance age (days) only
#   Model 4a: user count + federation
#   Model 4b: user count + age
#   Model 5:  all three predictors combined
# All continuous predictors are log-transformed or rescaled as appropriate.
#
# Input:  data/regression_data_lexicalfeature_fed_birth.csv
#         (per-instance lexical features, federation count, and birth date)
